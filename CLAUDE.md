...
A live dashboard of pipeline activity is available — `python3 dashboard/server.py`, see `dashboard/README.md`.
...
REQUIREMENTS_DOC: docs/finance-tracker/requirement.md
