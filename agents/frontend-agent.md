...
5. Record what you learned. For each blocking issue you fixed that carried a
   ...
   ```
   - YYYY-MM-DD | frontend | <ticket-id> | <the rule, verbatim from the reviewer>
   ```
